...
namespace HeneGames.DialogueSystem
{
    public class DialogueUI : MonoBehaviour
    {
        ...
        #endregion
         public void ShowOptionUI(string message, UnityAction onAccept, UnityAction onDecline)
    {
        // Implementa la UI para mostrar el mensaje y las opciones
        // Ejemplo simple: mostrar un panel con botones "Sí" y "No"
